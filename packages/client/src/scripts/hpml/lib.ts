...
> = {
	...
	for: {
		...
		out: null,
		category: "flow",
		icon: `${defaultStore.state.iconSet} ph-recycle ph-lg`,
	},
	not: {
		in: ["boolean"],
		out: "boolean",
		category: "logical",
		icon: `${defaultStore.state.iconSet} ph-flag ph-lg`,
	},
	or: {
		in: ["boolean", "boolean"],
		out: "boolean",
	...
	subtract: {
		...
		out: "number",
		category: "operation",
		icon: `${defaultStore.state.iconSet} ph-minus ph-lg`,
	},
	multiply: {
		in: ["number", "number"],
		out: "number",
	...
	divide: {
		...
		out: "number",
		category: "operation",
		icon: `${defaultStore.state.iconSet} ph-divide ph-lg`,
	},
	mod: {
		in: ["number", "number"],
		out: "number",
	...
	round: {
		...
		out: "number",
		category: "operation",
		icon: `${defaultStore.state.iconSet} ph-calculator ph-lg`,
	},
	eq: {
		in: [0, 0],
		out: "boolean",
		category: "comparison",
		icon: `${defaultStore.state.iconSet} ph-equals ph-lg`,
	},
	notEq: {
		in: [0, 0],
		out: "boolean",
		category: "comparison",
		icon: `${defaultStore.state.iconSet} ph-prohibit-insert ph-lg`,
	},
	gt: {
		in: ["number", "number"],
		out: "boolean",
	...
	gtEq: {
		...
		out: "boolean",
		category: "comparison",
		icon: `${defaultStore.state.iconSet} ph-caret-double-right ph-lg`,
	},
	ltEq: {
		in: ["number", "number"],
		out: "boolean",
	...
	pick: {
		...
		out: null,
		category: "list",
		icon: `${defaultStore.state.iconSet} ph-text-indent ph-lg`,
	},
	listLen: {
		in: [null],
		out: "number",
	...
	rannum: {
		...
		out: "number",
		category: "random",
		icon: `${defaultStore.state.iconSet} ph-dice-five ph-lg`,
	},
	dailyRannum: {
		in: ["number", "number"],
		out: "number",
